...
Les agents et le nombre de tours utilisent les valeurs de `defaults` dans ta config. Si aucun agent par défaut n'est configuré, utilise un preset ou `--agent-a/--agent-b` explicitement.
